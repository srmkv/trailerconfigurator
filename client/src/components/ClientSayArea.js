...
const ClientSayArea = () => {
  return (
    <section id="say" className="client-say-area-home-3 client-say-area-home-1">
      <img
        src="assets/images/banner/client-say.png"
        alt="VRE"
        className="client-say-bg"
      />
      <div className="container">
        <div className="client-say-title">
          <h3 className="font-size-1-45">Отзывы наших клиентов</h3>
        </div>
            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="client-say-inner">
                  ...
                  <h5 className="font-size-1-35">Иван Иванов</h5>
              ...
              <div className="swiper-slide">
                <div className="client-say-inner">
                  ...
                  <h5 className="font-size-1-35">Петр Петров</h5>
                  <span className="font-size-1-18 client-work-name">
                    г. Москва
                  </span>
                </div>
              ...
              <div className="swiper-slide">
                <div className="client-say-inner">
                  ...
                  <h5 className="font-size-1-35">Семен Смирнов</h5>
                  <span className="font-size-1-18 client-work-name">
                    г. Норильск
                  </span>
                </div>
